...
// set base for elements
 //TweenMax.set([".bigTasty"],{autoAlpha:0});
 TweenMax.set(["#overlay"],{clip:"rect(0px,0px,1105px,900px)",/*x:-800,*/ autoAlpha:0});

//start animation

//tl.to(".bigTasty", 2, { autoAlpha:1, ease:Power2.easeInOut})
tl.to("#overlay", 1.5, {clip:"rect(0px,800px,600px,0px)", autoAlpha:1, ease:Power2.easeInOut})
}
