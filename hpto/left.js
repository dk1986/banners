...
// set base for elements
 TweenMax.set(["#overlay"],{clip:"rect(0px,0px,1105px,900px)",/*x:-800,*/ autoAlpha:0});
  // TweenMax.set([".beefFlag", ".flag"],{x:350});

	TweenMax.set([".beefFlag", ".flag"],{clip:"rect(0px,0px,1105px,900px)"});

 TweenMax.set(["#overlay", ".bigTastyText"],{autoAlpha:0});


 TweenMax.set([".vindRestaurant"],{autoAlpha:0, x:100});


//start animation
//tl.to("#bigTastyChicken", 1, {x: 0, autoAlpha:1, ease:Power1.easeInOut})
tl.to("#overlay", 2.2, {clip:"rect(0px,1800px,600px,0px)", autoAlpha:1, ease:Power2.easeInOut})



tl.to(".bigTastyText", 2, { autoAlpha:1, ease:Power2.easeInOut}, -.1)

//tl.to([".beefFlag", ".flag"], 2, {x:0, autoAlpha:1, ease:Power3.easeInOut}, .4)
tl.to([".beefFlag", ".flag"], 2, {clip:"rect(0px,1800px,600px,0px)", autoAlpha:1, ease:Power2.easeInOut},-.2)
